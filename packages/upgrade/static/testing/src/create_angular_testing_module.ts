 ...
 * AngularJS part.
 *
 * <code-example path="upgrade/static/ts/module.spec.ts" region="angular-setup"></code-example>
 *
 ...
 * service, `titleCase`.
 *
 * <code-example path="upgrade/static/ts/module.spec.ts" region="angular-spec"></code-example>
 *
